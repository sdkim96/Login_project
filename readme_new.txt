...
* 분석 및 개발 내용
        ...
        - 웹 크롤링
                - 네이버 지도 (김만기)
                        ...
                        - 업소 리스트를 네이버지도에서 검색후 숙박업 정보별점, 후기 등) 수집
                - 야놀자 (신호철, 김성진)
                        - 야놀자 홈페이지에서 서울의 '모텔/호텔' 숙박업 정보(별점, 후기 등) 수집
        - 데이터 분석
                - 관광지, 관광객 특징 분석(정지용)
                        - (방법) 관광객 로그 데이터의 통계 및 군집 분석
                ...
                - 숙박업소와 관광지 관련성 분석
                        ...
                        - (내용1) 숙박업체 - 교통 - 관광지 데이터간 연결링크 개발 작업 (이가연)
                                - 숙소 주변 교통수단, 관광지와의 거리계산
                                - 각  거리를 기반으로 관련정보들(주변 숙소의 수, 관광지와의 거리 등)을 새로운 특성으로 추가
                        - (내용3) 관광지, 교통, 호텔위치 정보를 이용한 군집분석 (정지용)
                - 숙박업소 후기정보 분석
                        - 
                        
                - 
        - 웹 개발
                - 웹페이지 기초 구성요소(홈, 프로젝트 소개, 프로젝트 코드 및 시각화) 설정 및 구축
                - 
