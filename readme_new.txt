...
* 분석 및 개발 내용
        ...
        - 데이터 분석
                ...
                - 숙박업소와 관광지 관련성 분석(이가연, 정지용)
                        - (방법) 관광객 로그 데이터와 교통,숙박업소 정보 결합 및 군집 분석
                        - (내용1) 숙박업체 - (교통) - 관광지 데이터간 연결링크 개발 작업 (이가연)
                                - 관광지 주변 교통수단 링크: 관광지와 가까운 교통수단 정보 속성 생산 및 추가
                                - 숙박업소 주변 교통수단 링크: 숙박업소와 가까운 교통수단 정보 속성 생산 및 추가
                        - (내용3) 관광지, 교통, 호텔위치 정보를 이용한 군집분석 (정지용)
                - 크롤링 데이터(숙박업소 후기정보) 분석
                        - 야놀자 인기태그 및 별점별 후기 워드클라우드 (김성진)
                        - 야놀자 호텔 유형별 속성 기초통계 분석 (신호철)
                        - 
